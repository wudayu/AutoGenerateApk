...
public final class MyMessageClient_
    implements MyMessageClient
{
    ...
    @Override
    public XcfcMyMessageResult getMyMessages(String url, int pageNo, String userId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/msg/getMyMsg/{pageNo}?id={userId}"), HttpMethod.GET, requestEntity, XcfcMyMessageResult.class, urlVariables).getBody();
