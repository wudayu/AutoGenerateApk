...
public final class ClientSearchClient_
    implements ClientSearchClient
{
    ...
    @Override
    public XcfcClientResult getClients(String url, int pageNum, String brokerId, String name) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/searchClient/{pageNum}?brokerId={brokerId}&name={name}"), HttpMethod.GET, requestEntity, XcfcClientResult.class, urlVariables).getBody();
