...
public final class QQBindClient_
    implements QQBindClient
{
    ...
    @Override
    public XcfcUserResult bindQQ(String url, String token, String clientPhone, String password, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/qqbind?mqq={token}&clientPhone={clientPhone}&password={password}&id={id}"), HttpMethod.GET, requestEntity, XcfcUserResult.class, urlVariables).getBody();
