...
public final class CustomerDetailClient_
    implements CustomerDetailClient
{
    ...
    @Override
    public XcfcCustomerDetailResult getCustomerDetail(String url, String brokerId, String clientId, String status) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/getBrokerClientinfo?brokerId={brokerId}&clientId={clientId}&status={status}"), HttpMethod.GET, requestEntity, XcfcCustomerDetailResult.class, urlVariables).getBody();
