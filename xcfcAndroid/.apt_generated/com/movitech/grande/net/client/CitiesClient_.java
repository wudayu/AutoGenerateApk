...
public final class CitiesClient_
    implements CitiesClient
{
    ...
    @Override
    public XcfcCitiesResult getCitys(String url) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/sys/getCitys"), HttpMethod.GET, requestEntity, XcfcCitiesResult.class, urlVariables).getBody();
