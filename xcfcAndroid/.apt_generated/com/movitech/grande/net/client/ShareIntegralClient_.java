...
public final class ShareIntegralClient_
    implements ShareIntegralClient
{
    ...
    @Override
    public BaseResult getShareIntegral(String url, String brokerId, String sourceId) {
        ...
        urlVariables.put("sourceId", sourceId);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/addShareIntegral?brokerId={brokerId}&sourceId={sourceId}"), HttpMethod.GET, requestEntity, BaseResult.class, urlVariables).getBody();
