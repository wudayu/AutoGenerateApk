...
public final class ReNameClient_
    implements ReNameClient
{
    ...
    @Override
    public BaseResult reName(String url, String id, String name) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/updateBroker?id={id}&name={name}"), HttpMethod.GET, requestEntity, BaseResult.class, urlVariables).getBody();
