...
public final class IntegralClient_
    implements IntegralClient
{
    ...
    @Override
    public XcfcIntegralResult getIntegral(String url, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/getIntegral?id={id}"), HttpMethod.GET, requestEntity, XcfcIntegralResult.class, urlVariables).getBody();
