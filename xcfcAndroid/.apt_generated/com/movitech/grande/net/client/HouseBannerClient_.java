...
public final class HouseBannerClient_
    implements HouseBannerClient
{
    ...
    @Override
    public XcfcHouseBanner[] getHouseBanner(String url, String type, String city) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryBanners?type={type}&city={city}"), HttpMethod.GET, requestEntity, XcfcHouseBanner[].class, urlVariables).getBody();
