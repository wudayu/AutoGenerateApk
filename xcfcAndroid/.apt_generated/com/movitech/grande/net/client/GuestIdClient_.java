...
public final class GuestIdClient_
    implements GuestIdClient
{
    ...
    @Override
    public XcfcGuestIdResult getGuestIdResult(String url, String deviceId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/addGuest?androidDevice={deviceId}"), HttpMethod.GET, requestEntity, XcfcGuestIdResult.class, urlVariables).getBody();
