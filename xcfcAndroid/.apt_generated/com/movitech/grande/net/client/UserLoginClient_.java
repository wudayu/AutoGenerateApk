...
public final class UserLoginClient_
    implements UserLoginClient
{
    ...
    @Override
    public XcfcUserResult userLogin(String url, String username, String password) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/login?username={username}&password={password}"), HttpMethod.GET, requestEntity, XcfcUserResult.class, urlVariables).getBody();
