...
public final class AppointmentClient_
    implements AppointmentClient
{
    ...
    @Override
    public XcfcAppointmentResult getAppointmentResult(String url, String clientName, String clientPhone, String recommendedBuilding, String brokerId, String bespeakMark, String bespeakTime) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("recommendedBuilding", recommendedBuilding);
        urlVariables.put("clientPhone", clientPhone);
        urlVariables.put("clientName", clientName);
        urlVariables.put("brokerId", brokerId);
        urlVariables.put("bespeakMark", bespeakMark);
        urlVariables.put("url", url);
        urlVariables.put("bespeakTime", bespeakTime);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/beSpeakedClientByBroker?clientName={clientName}&clientPhone={clientPhone}&recommendedBuilding={recommendedBuilding}&brokerId={brokerId}&bespeakMark={bespeakMark}&bespeakTime={bespeakTime}"), HttpMethod.GET, requestEntity, XcfcAppointmentResult.class, urlVariables).getBody();
