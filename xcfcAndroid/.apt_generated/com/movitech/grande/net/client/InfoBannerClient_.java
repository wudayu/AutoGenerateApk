...
public final class InfoBannerClient_
    implements InfoBannerClient
{
    ...
    @Override
    public XcfcInfoBannerResult getInfoBanner(String url, String type) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryNewsBanner/{type}"), HttpMethod.GET, requestEntity, XcfcInfoBannerResult.class, urlVariables).getBody();
