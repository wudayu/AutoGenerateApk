...
public final class FavBuildClient_
    implements FavBuildClient
{
    ...
    @Override
    public XcfcFavBuildResult getFavBuild(String url, String brokerId, String relationId, String isLike, String sourceType) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("sourceType", sourceType);
        urlVariables.put("isLike", isLike);
        urlVariables.put("brokerId", brokerId);
        urlVariables.put("url", url);
        urlVariables.put("relationId", relationId);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/addCollect?brokerId={brokerId}&relationId={relationId}&isLike={isLike}&sourceType={sourceType}"), HttpMethod.GET, requestEntity, XcfcFavBuildResult.class, urlVariables).getBody();
