...
public final class CancelFavBuildClient_
    implements CancelFavBuildClient
{
    ...
    @Override
    public XcfcCancelFavBuild getCancelFavBuild(String url, String brokerId, String relationId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/delCollect?brokerId={brokerId}&relationId={relationId}"), HttpMethod.GET, requestEntity, XcfcCancelFavBuild.class, urlVariables).getBody();
