...
public final class RePasswardClient_
    implements RePasswardClient
{
    ...
    @Override
    public BaseResult rePassward(String url, String username, String oldpassword, String newpassword) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("oldpassword", oldpassword);
        urlVariables.put("username", username);
        urlVariables.put("newpassword", newpassword);
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/updatePassword?username={username}&oldpassword={oldpassword}&newpassword={newpassword}"), HttpMethod.GET, requestEntity, BaseResult.class, urlVariables).getBody();
