...
public final class MyUnreadCountClient_
    implements MyUnreadCountClient
{
    ...
    @Override
    public XcfcStringResult getUnreadCount(String url, String userId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/msg/getMyUnreadMsgNum?id={userId}"), HttpMethod.GET, requestEntity, XcfcStringResult.class, urlVariables).getBody();
