...
public final class ServiceTermsClient_
    implements ServiceTermsClient
{
    ...
    @Override
    public XcfcServiceTermsResult getServicesTerms(String url, int type) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/sys/getStatement?type={type}"), HttpMethod.GET, requestEntity, XcfcServiceTermsResult.class, urlVariables).getBody();
