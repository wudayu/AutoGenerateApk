...
public final class HousesDetailClient_
    implements HousesDetailClient
{
    ...
    @Override
    public XcfcHousesDetailResult getHousesDetail(String url, String id, String operatorId) {
        ...
        urlVariables.put("operatorId", operatorId);
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/queryBuildingInfo?id={id}&operatorId={operatorId}"), HttpMethod.GET, requestEntity, XcfcHousesDetailResult.class, urlVariables).getBody();
