...
public final class PushMessageClient_
    implements PushMessageClient
{
    ...
    @Override
    public XcfcPushMessageResult getPushMessage(String url, String brokerId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/sms/getPushMsg/{brokerId}"), HttpMethod.GET, requestEntity, XcfcPushMessageResult.class, urlVariables).getBody();
