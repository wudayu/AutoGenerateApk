...
public final class OrgBrokerDetailClient_
    implements OrgBrokerDetailClient
{
    ...
    @Override
    public XcfcOrgBrokerDetailResult getOrgBrokerInfo(String url, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/getOrgBrokerInfo?id={id}"), HttpMethod.GET, requestEntity, XcfcOrgBrokerDetailResult.class, urlVariables).getBody();
