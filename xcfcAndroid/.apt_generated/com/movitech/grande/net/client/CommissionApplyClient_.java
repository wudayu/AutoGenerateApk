...
public final class CommissionApplyClient_
    implements CommissionApplyClient
{
    ...
    @Override
    public XcfcCommissionApplyResult getApplyResult(String url, String brokerId, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/givemebrokerage?brokerId={brokerId}&id={id}"), HttpMethod.GET, requestEntity, XcfcCommissionApplyResult.class, urlVariables).getBody();
