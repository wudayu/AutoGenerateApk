...
public final class VersionClient_
    implements VersionClient
{
    ...
    @Override
    public XcfcVersionResult getVersion(String url, int type) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/sys/getVersion?type={type}"), HttpMethod.GET, requestEntity, XcfcVersionResult.class, urlVariables).getBody();
