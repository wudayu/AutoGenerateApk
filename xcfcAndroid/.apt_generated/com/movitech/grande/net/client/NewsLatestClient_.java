...
public final class NewsLatestClient_
    implements NewsLatestClient
{
    ...
    @Override
    public XcfcStringResult getLatestTime(String url, String type) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryTopNewsTime?type={type}"), HttpMethod.GET, requestEntity, XcfcStringResult.class, urlVariables).getBody();
