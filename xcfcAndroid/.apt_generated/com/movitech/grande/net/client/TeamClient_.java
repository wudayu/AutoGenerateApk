...
public final class TeamClient_
    implements TeamClient
{
    ...
    @Override
    public XcfcTeamResult getTeamResult(String url, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/myTeam?id={id}"), HttpMethod.GET, requestEntity, XcfcTeamResult.class, urlVariables).getBody();
