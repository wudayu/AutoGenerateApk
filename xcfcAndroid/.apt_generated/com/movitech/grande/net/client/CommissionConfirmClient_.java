...
public final class CommissionConfirmClient_
    implements CommissionConfirmClient
{
    ...
    public CommissionConfirmClient_() {
    ...
    @Override
    public XcfcCommissionConfirmResult getCommissionsConfirm(String url, String brokerId, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/updateBrokerageState/{brokerId}/{id}"), HttpMethod.GET, requestEntity, XcfcCommissionConfirmResult.class, urlVariables).getBody();
