...
public final class HuStyleClient_
    implements HuStyleClient
{
    ...
    @Override
    public XcfcHuStyleResult getHuStyleResult(String url, String itemId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/queryBuildingHouseType?itemId={itemId}"), HttpMethod.GET, requestEntity, XcfcHuStyleResult.class, urlVariables).getBody();
