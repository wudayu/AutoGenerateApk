...
public final class VerificationCodeClient_
    implements VerificationCodeClient
{
    ...
    public VerificationCodeClient_() {
    ...
    @Override
    public XcfcVerificationCodeResult checkVerificationCode(String url, String phone, String code) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/sms/checkSmsCode/{phone}/{code}"), HttpMethod.GET, requestEntity, XcfcVerificationCodeResult.class, urlVariables).getBody();
    ...
    @Override
    public BaseResult getVerificationCode(String url, String phone) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        ...
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/sms/getSmsCode/{phone}"), HttpMethod.GET, requestEntity, BaseResult.class, urlVariables).getBody();
        } catch (RestClientException e) {
            if (restErrorHandler!= null) {
                restErrorHandler.onRestClientExceptionThrown(e);
                return null;
