...
public final class SubOrgStatusClient_
    implements SubOrgStatusClient
{
    ...
    @Override
    public BaseResult getSubOrgStatus(String url, String id, String isDisabled) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("isDisabled", isDisabled);
        urlVariables.put("id", id);
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/isDisabled?id={id}&isDisabled={isDisabled}"), HttpMethod.GET, requestEntity, BaseResult.class, urlVariables).getBody();
