...
public final class DayMarkClient_
    implements DayMarkClient
{
    ...
    @Override
    public XcfcDayMarkResult getDayMark(String url, String id) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/dayMark/{id}"), HttpMethod.GET, requestEntity, XcfcDayMarkResult.class, urlVariables).getBody();
