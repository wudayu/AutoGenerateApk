...
public final class BrokerDetailClient_
    implements BrokerDetailClient
{
    ...
    @Override
    public XcfcBrokerDetailResult getBrokerDetail(String url, String brokerId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/getBrokerInfo?id={brokerId}"), HttpMethod.GET, requestEntity, XcfcBrokerDetailResult.class, urlVariables).getBody();
