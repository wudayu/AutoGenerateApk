...
public final class CommissionClient_
    implements CommissionClient
{
    ...
    @Override
    public XcfcCommissionResult getCommissions(String url, int pageNo, String brokerId, String status) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/brokerageList/{pageNo}?brokerId={brokerId}&status={status}"), HttpMethod.GET, requestEntity, XcfcCommissionResult.class, urlVariables).getBody();
