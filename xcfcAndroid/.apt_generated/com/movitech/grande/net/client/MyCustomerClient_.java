...
public final class MyCustomerClient_
    implements MyCustomerClient
{
    ...
    @Override
    public XcfcMyCustomerResult getMyCustomer(String url, int pageNo, String id, String isVip, String isVisited, String isSignup, String state) {
        ...
        urlVariables.put("isVisited", isVisited);
        urlVariables.put("isVip", isVip);
        urlVariables.put("pageNo", pageNo);
        urlVariables.put("state", state);
        urlVariables.put("isSignup", isSignup);
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/brokerClientList/{pageNo}?id={id}&isVip={isVip}&isVisited={isVisited}&isSignup={isSignup}&state={state}"), HttpMethod.GET, requestEntity, XcfcMyCustomerResult.class, urlVariables).getBody();
