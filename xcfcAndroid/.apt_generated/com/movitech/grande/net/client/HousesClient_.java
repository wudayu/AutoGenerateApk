...
public final class HousesClient_
    implements HousesClient
{
    ...
    @Override
    public XcfcHousesResult getHouses(String url, int pageNo, String city, String district, String name, String isRecommend, String isHot) {
        ...
        urlVariables.put("district", district);
        urlVariables.put("isRecommend", isRecommend);
        urlVariables.put("url", url);
        urlVariables.put("city", city);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/queryBuilding/{pageNo}?city={city}&area={district}&name={name}&isRecommand={isRecommend}&isHot={isHot}"), HttpMethod.GET, requestEntity, XcfcHousesResult.class, urlVariables).getBody();
