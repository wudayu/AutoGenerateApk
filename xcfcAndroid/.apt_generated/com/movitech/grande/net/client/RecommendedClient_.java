...
public final class RecommendedClient_
    implements RecommendedClient
{
    ...
    @Override
    public XcfcRecommendedResult getRecommendResult(String url, String clientName, String clientPhone, String recommendedBuilding, String brokerId, String recommendMark) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("recommendMark", recommendMark);
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/brokerRecommendClient?clientName={clientName}&clientPhone={clientPhone}&recommendedBuilding={recommendedBuilding}&brokerId={brokerId}&recommendMark={recommendMark}"), HttpMethod.GET, requestEntity, XcfcRecommendedResult.class, urlVariables).getBody();
