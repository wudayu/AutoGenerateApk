...
public final class EarnIntegralClient_
    implements EarnIntegralClient
{
    ...
    @Override
    public XcfcEarnIntegralResult getEarnIntegral(String url, String brokerId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/getBrokerIntegral/{brokerId}"), HttpMethod.GET, requestEntity, XcfcEarnIntegralResult.class, urlVariables).getBody();
