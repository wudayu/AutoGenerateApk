...
public final class InfoeDetailClient_
    implements InfoeDetailClient
{
    ...
    @Override
    public XcfcInfoDetailResult getInfoDetail(String url, String infoId, String operatorId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryNewsInfo?id={infoId}&operatorId={operatorId}"), HttpMethod.GET, requestEntity, XcfcInfoDetailResult.class, urlVariables).getBody();
