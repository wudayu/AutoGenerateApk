...
public final class IsCollectClient_
    implements IsCollectClient
{
    ...
    @Override
    public XcfcIsCollectResult getIsCollect(String url, String brokerId, String relationId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/isCollect?brokerId={brokerId}&relationId={relationId}"), HttpMethod.GET, requestEntity, XcfcIsCollectResult.class, urlVariables).getBody();
