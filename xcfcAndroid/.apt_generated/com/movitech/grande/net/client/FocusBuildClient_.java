...
public final class FocusBuildClient_
    implements FocusBuildClient
{
    ...
    @Override
    public XcfcHousesCollectionResult getFocusBuild(String url, String brokerId) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/building/queryBuildingCollect?brokerId={brokerId}"), HttpMethod.GET, requestEntity, XcfcHousesCollectionResult.class, urlVariables).getBody();
