...
public final class InfoesClient_
    implements InfoesClient
{
    ...
    @Override
    public XcfcInfoesResult getHotActions(String url, int pageNo, String catagoryId, String isHot, String houseId) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        HashMap<String, Object> urlVariables = new HashMap<String, Object>();
        urlVariables.put("catagoryId", catagoryId);
        urlVariables.put("pageNo", pageNo);
        urlVariables.put("isHot", isHot);
        urlVariables.put("houseId", houseId);
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryBuildingNews/{pageNo}?catagoryId={catagoryId}&isHot={isHot}&buildings={houseId}"), HttpMethod.GET, requestEntity, XcfcInfoesResult.class, urlVariables).getBody();
    ...
    @Override
    public XcfcInfoesResult getInfoes(String url, int pageNo, String catagoryId, String isHot, String houseId) {
        HttpHeaders httpHeaders = new HttpHeaders();
        httpHeaders.setAccept(Collections.singletonList(MediaType.parseMediaType("application/json")));
        httpHeaders.set("Content-Type", availableHeaders.get("Content-Type"));
        HttpEntity<Object> requestEntity = new HttpEntity<Object>(httpHeaders);
        ...
        urlVariables.put("url", url);
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/news/queryNews/{pageNo}?catagoryId={catagoryId}&isHot={isHot}&buildings={houseId}"), HttpMethod.GET, requestEntity, XcfcInfoesResult.class, urlVariables).getBody();
        } catch (RestClientException e) {
            if (restErrorHandler!= null) {
                restErrorHandler.onRestClientExceptionThrown(e);
                return null;
