...
public final class ForgetPassWordClient_
    implements ForgetPassWordClient
{
    ...
    @Override
    public XcfcForgetPassWordResult sendNewPassWord(String url, String username, String newpassword) {
        ...
        try {
            return restTemplate.exchange(rootUrl.concat("{url}/rest/broker/forgetPassword?username={username}&newpassword={newpassword}"), HttpMethod.GET, requestEntity, XcfcForgetPassWordResult.class, urlVariables).getBody();
