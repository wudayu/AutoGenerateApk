...
/**
 * @author Warkey.Song
 * @version 创建时间：2014年7月18日 下午3:30:06
 * 类说明
 */
@EFragment(R.layout.layout_gridview_activity_customer)
public class CustomerImportantFragment extends BaseFragment{
	...
	@AfterViews
	void afterViews(){
		gridviewCustomer.setOnScrollToEdgeCallBack(new OnScrollToEdgeCallBack() {
   ...
   @Background
	...
	void doBindData() {
	    ...
	    gridViewAdapter = new CustomerGridViewAdapter(context, customers);
	...
	void addCustomerItems() {
		gridViewAdapter.addItems(xcfcMyCustomerResult.getPageResult().getCustomers());
