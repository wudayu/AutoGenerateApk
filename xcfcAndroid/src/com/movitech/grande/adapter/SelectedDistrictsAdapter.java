...
/**
 * @author Warkey.Song
 * @version 创建时间：2014年7月1日 下午12:53:53 类说明
 */
public class SelectedDistrictsAdapter extends BaseAdapter {
	...
	public SelectedDistrictsAdapter(Context context, XcfcDistrict[] district,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			cache.tvSelectedDistricts = (TextView) convertView
					.findViewById(R.id.tv_selected_districts);
